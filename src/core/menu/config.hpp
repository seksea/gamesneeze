    ...
    inline std::unordered_map<std::string_view, ConfigItem> config {
        // Visuals {
            // ESP {
                ...
                CONFIGITEM("Visuals>Enemies>ESP>Health Bar Color", ImColor(0, 240, 0, 255)),
                ...
                CONFIGITEM("Visuals>Enemies>ESP>Radar", false),
                ...
                CONFIGITEM("Visuals>Teammates>ESP>Health Bar Color", ImColor(0, 240, 0, 255)),
