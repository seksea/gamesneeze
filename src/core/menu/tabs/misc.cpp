...
void Menu::drawMiscTab() {
    if (ImGui::BeginTabBar("##miscTabs")) {
        if (ImGui::BeginTabItem("Misc")) {
            ...
            if (ImGui::IsItemHovered())
                ImGui::SetTooltip("sekc (of course)\nAll other contributors on GitHub (xXx-sans-xXx, luk1337, cristeigabriel, crazily, dave (@dweee), keenan, u2ooS, tango1337, nigma1337, vampur, allbombson and any other contributors)\nDonators:\n moke#9091/github.com/mokeWe - 0.19XMR (~$30)\n hx#5185 - 0.2XMR (~$30)\nand ocornut for his great ImGui UI framework");
            ImGui::EndTabItem();
        }
